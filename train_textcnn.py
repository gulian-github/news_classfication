...
from model import Model, TextCNNModel
...
save_model_path = 'bert_textcnn.bin'
save_pred_path = "./bert_textcnn.csv"
dropout = 0.15
...
for i in range(n_fold):
    ...
    model = TextCNNModel(vocab, bert_path, max_sent_len, dropout,
...
ans.to_csv('./bert_average_5_textcnn.csv', index=False)
